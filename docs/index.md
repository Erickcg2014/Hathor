...
El proyecto está organizado en un único repositorio que divide las responsabilidades del sistema:
...
- **`hathorfront/`** _(o el nombre de tu carpeta frontend)_: La interfaz de usuario. Desarrollada en **Angular**, enfocada en ser intuitiva, modular y rápida.
...
| **Frontend**      | Angular 19+                | Interfaz gráfica y experiencia de usuario.   |
| **Base de Datos** | PostgreSQL / Supabase      | Almacenamiento relacional de datos.          |
| **Documentación** | Github Pages y Github Docs | Manuales técnicos y documentación de código. |
...
1.  **[Arquitectura](arquitectura.md)**: Vista del sistema, diagramas de vista lógica y cómo se comunican y relacionan el Front, el API Gateway y el Back.
