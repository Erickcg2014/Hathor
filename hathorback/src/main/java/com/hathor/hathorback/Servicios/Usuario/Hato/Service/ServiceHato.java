...
import com.hathor.hathorback.Servicios.Usuario.Hato.DTO.OpcionesHatoDTO;
...
public class ServiceHato implements IServiceHato {
    ...
    @Override
    public Hato actualizarInfoHato(UUID idHato, RegistroHatoDTO dto, String email) {
        Hato hato = findHatoById(idHato, email);
        hato.setNombreHato(dto.getNombreHato());
        hato.setDepartamento(dto.getDepartamento());
        hato.setCiudad(dto.getCiudad());
        hato.setAltitud(dto.getAltitud());
        hato.setTropico(dto.getTropico());
        hato.setAreaHato(dto.getAreaHato());
        hato.setAreaPastoreo(dto.getAreaPastoreo());
        ...
        hato.setTipoHato(dto.getTipoHato());
        if (dto.getLatitud() != null) hato.setLatitud(dto.getLatitud());
        if (dto.getLongitud() != null) hato.setLongitud(dto.getLongitud());
        return repositoryHato.save(hato);
    }
    ...
    @Override
    public OpcionesHatoDTO getOpciones() {
        List<String> tipos = repositoryHato.findTiposHatoUnicos();
        List<String> tropicos = repositoryHato.findTropicosUnicos();
        return new OpcionesHatoDTO(tipos, tropicos);
    }
